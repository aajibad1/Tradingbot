"""Pub/Sub subscriber wrapper — identical contract to opportunity-engine's, kept
per-service (shared/ only holds cross-service code, per CLAUDE.md's service
boundary rule) so this service still depends on nothing but shared/ + Pub/Sub.
"""
