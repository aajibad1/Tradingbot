...
| `min_net_edge_bps` | 50.0 bps | Below this, the spread does not reliably clear fees + slippage + safety buffer. Matches `shared/utils/fee_calculator.MIN_VIABLE_NET_EDGE_BPS`. |
