...
ALL_SERVICES=(
  ...
  core-api accounts-service account-link-service corridor-engine opportunity-ranker signal-engine corridor-intelligence-service debate-service status-service
)
